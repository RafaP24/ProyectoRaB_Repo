...
public class ProgramaciónBase : MonoBehaviour
{
    //Variables primitivas
    public int edadPersona = 24;
    public float altura = 1.64f;
    public string nombre = "Rafa";
    public bool llevaGafas = false;
    ...
    //Método sin tipo de dato, con variable de referencia  = Acción que usa una valor flexible
    void EscanearEstadistica(int estadistica)
    {
        Debug.Log(estadistica + " tienes tanto de ese start!");
